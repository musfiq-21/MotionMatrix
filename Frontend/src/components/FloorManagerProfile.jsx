...
import '../styles/FloorManagerProfile.css';
import '../styles/messaging-modal.css';
import SocketService from '../services/socketService';

export default function FloorManagerProfile({ user, currentUser }) {
  ...
  return (
    <div className="floor-manager-profile-container">
      ...
      <div className="work-info-section">
        ...
        <div className="info-grid">
          ...
          <div className="info-box">
            <span className="info-icon">📍</span>
            <div className="info-content">
              <p className="info-label">Floor Management</p>
              <p className="info-value">{user?.department} Department</p>
            </div>
          </div>
